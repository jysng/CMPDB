<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/layout.Master" CodeBehind="BLOBUpdate.aspx.vb" Inherits="CMPDSB_DEVIN.BLOBUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="ContainerOne">
            <div class="col1">
                <asp:Button runat="server" Enabled="false" Text="Upload Template" ID="btnUploadTemplate" OnClick="btnUploadTemplate_Click" />
